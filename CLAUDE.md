...
- **Page** — A tab in a Figma file containing multiple frames. Not an app concept. Share a Figma URL for the frame you want built (preferred), or select the frame in the Figma desktop app for quick checks. Do not use screenshots as the primary input — see Figma Input Rules above.
